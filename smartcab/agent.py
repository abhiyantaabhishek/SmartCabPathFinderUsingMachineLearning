...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = 0.999 ** self.step
            self.epsilon = math.cos(self.const*self.step)
    ...
    def get_maxQ(self, state):
        ...
        #maxQ = None
        maxAction = max(self.Q[state], key=lambda act: self.Q[state][act])
...
def run():
    ...
    env = Environment(verbose=False, num_dummies=80, grid_size = (8, 4))
